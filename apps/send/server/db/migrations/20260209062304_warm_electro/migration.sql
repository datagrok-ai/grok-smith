...
-- studies FKs
DO $$ BEGIN
 ALTER TABLE "send"."studies" ADD CONSTRAINT "studies_entity_id_entities_id_fk" FOREIGN KEY ("entity_id") REFERENCES "public"."entities"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "send"."studies" ADD CONSTRAINT "studies_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
-- Detail table FKs (all CASCADE on study_id)
DO $$ BEGIN
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_findings_study_domain" ON "send"."findings" USING btree ("study_id","domain");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_findings_subject" ON "send"."findings" USING btree ("subject_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_findings_domain_test" ON "send"."findings" USING btree ("domain","test_code");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_findings_study_subject_domain" ON "send"."findings" USING btree ("study_id","subject_id","domain");
--> statement-breakpoint
